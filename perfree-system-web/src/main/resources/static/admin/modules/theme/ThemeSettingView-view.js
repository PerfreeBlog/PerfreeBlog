import { g as V } from "./lib/theme.js";
function h(p) {
...
const g = window.Vue.resolveComponent, S = window.Vue.createVNode, w = window.Vue.openBlock, k = window.Vue.createBlock, T = window.Vue.createCommentVNode, B = window.Vue.resolveDirective, E = window.Vue.createElementBlock, x = window.Vue.withDirectives, y = { class: "page" }, l = window.ElementPlus.ElMessage, i = window.Vue.ref, D = {
      ...
      V().then((t) => {
        if (t.code === 200) {
          ...
          r.value = t.data.option, r.value.onSubmit = _, m.value = t.data.rule, C().then((e) => {
            e.code === 200 ? s.value = e.data.reduce((n, { key: o, value: u }) => (n[o] = u, n), {}) : l.success(e.msg), a.value = !1;
          });
        } else
