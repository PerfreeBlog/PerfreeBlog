layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color, second) {
		...
		style += '.p-text-btn {color:'+color+'}'
		style += '.p-text-btn:hover {color:'+color+'}'
		style += '.themeBtn:hover {color:'+color+'}'
		style += '.activeBtn .fa {color:'+color+'}'
		style += '.tipBox a {color:'+color+'}'
