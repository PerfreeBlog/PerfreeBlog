...
<body class="layui-layout-body">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="name" placeholder="请输入文件名" id="name" onkeydown="if(event.keyCode===13){event.keyCode=0;event.returnValue=false;}" autocomplete="off" class="layui-input">
                                </div>
                            </div>
    ...
    <script src="/admin/pages/attach/js/attach_list.js"></script>
</body>
</html>