    ...
    <form class="layui-form" lay-filter="addForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" value="${category.name}" required  lay-verify="required" placeholder="请输入菜单名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">描述:</label>
            <div class="layui-input-block">
                <textarea name="desc" style="resize:none;" placeholder="请输入描述" class="layui-textarea">${category.desc}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="status" lay-verify="required">
                    <option value="0" <#if (category.status)== 0>selected</#if>>正常</option>
                    <option value="1" <#if (category.status)== 1>selected</#if>>禁用</option>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item" >
            ...
            <div class="layui-input-inline">
                <input type="text" value="${category.metaKeywords}" name="metaKeywords" placeholder="请输入SEO关键字" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="metaDescription" style="resize:none;" placeholder="请输入SEO描述内容" class="layui-textarea">${category.metaDescription}</textarea>
            </div>
        </div>
