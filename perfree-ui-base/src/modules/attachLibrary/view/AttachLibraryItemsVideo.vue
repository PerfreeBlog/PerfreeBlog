  ...
  <div>
    <div class="search-box">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline" ref="searchFormRef">
        <el-form-item label="视频名称">
          <el-input v-model="searchForm.name" placeholder="请输入视频名称" clearable/>
        </el-form-item>
        <el-form-item>
    ...
    <div class="table-box">
      <el-table :data="tableData" style="width: 100%;height:100%;" row-key="id" v-loading="loading" >
        <el-table-column prop="name" label="视频名称" min-width="160" show-overflow-tooltip/>
        <el-table-column prop="url" label="视频" min-width="160">
          <template v-slot="scope">
            <video preload="none" controls style="width: 100%; max-height: 100%">
    ...
    <el-dialog v-model="open" :title="title" width="600px" draggable>
      ...
      >
        <el-form-item label="视频" prop="url">
          <attach-select-input :attach-type="'video'" :enable-input="true" :placeholder="'请选择或输入视频地址'" v-model:model-value="addForm.url" @attach-select-change="attachSelectChange"></attach-select-input>
        </el-form-item>
        <el-form-item label="视频名称" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入视频名称"/>
        </el-form-item>
    ...
    <el-dialog v-model="attachShow" :title="title" width="900px" draggable destroy-on-close>
      <attach-select-panel @update:selected-attach="selectAttach" :max="99" :attach-type="'video'"></attach-select-panel>
      <template #footer>
        <span class="dialog-footer">
...
const addRule = reactive({
  name: [{required: true, message: '视频库名称不能为空', trigger: 'blur'}],
  url: [{required: true, message: '视频地址不能为空', trigger: 'blur'}],
});
