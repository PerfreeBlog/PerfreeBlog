  ...
  <div class="page">
    ...
    <div class="table-box">
      ...
      <el-table :data="tableData" style="width: 100%;height:100%;" row-key="id" v-loading="loading" >
        <el-table-column prop="extraName" label="名称" min-width="150" show-overflow-tooltip/>
        <el-table-column prop="extraKey" label="key" min-width="150" show-overflow-tooltip/>
        <el-table-column prop="extraDescription" label="描述" min-width="240" show-overflow-tooltip/>
