var su = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Go = { exports: {} };
(function(Uo, uu) {
  (function(re, Lr) {
    Uo.exports = Lr();
  })(su, function() {
    var re = navigator.userAgent, Lr = navigator.platform, He = /gecko\/\d/i.test(re), Mn = /MSIE \d/.test(re), Dn = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(re), kr = /Edge\/(\d+)/.exec(re), A = Mn || Dn || kr, E = A && (Mn ? document.documentMode || 6 : +(kr || Dn)[1]), ie = !kr && /WebKit\//.test(re), Ko = ie && /Qt\/\d+\.\d+/.test(re), $e = !kr && /Chrome\/(\d+)/.exec(re), _o = $e && +$e[1], Ce = /Opera\//.test(re), Tr = /Apple Computer/.test(navigator.vendor), Xo = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(re), Yo = /PhantomJS/.test(re), Ut = Tr && (/Mobile\/\w+/.test(re) || navigator.maxTouchPoints > 2), Mr = /Android/.test(re), Kt = Ut || Mr || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(re), ye = Ut || /Mac/.test(Lr), qo = /\bCrOS\b/.test(re), Zo = /win/i.test(Lr), et = Ce && re.match(/Version\/(\d*\.\d*)/);
    et && (et = Number(et[1])), et && et >= 15 && (Ce = !1, ie = !0);
    var Nn = ye && (Ko || Ce && (et == null || et < 12.11)), ci = He || A && E >= 9;
    function mt(e) {
    ...
    var An = 50, Nr = { toString: function() {
    ...
    function Wn(e, t) {
      var i;
      return Object.create ? i = Object.create(e) : (On.prototype = e, i = new On()), t && nt(t, i), i;
    }
        ...
        for (var X = 0; X < d; ++X)
          if (n.test(c[X])) {
            ...
            for (_ = X + 1; _ < d && n.test(c[_]); ++_)
              ;
            for (var R = (X ? c[X - 1] : h) == "L", he = (_ < d ? c[_] : h) == "L", zt = R == he ? R ? "L" : "R" : h, Ve = X; Ve < _; ++Ve)
              c[Ve] = zt;
            X = _ - 1;
          }
    ...
    function ta(e) {
      ...
      var i = Si ? k("span", "​") : k("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
...
`, t);
    ...
    function Hr(e) {
      if (typeof e == "string" && Ct.hasOwnProperty(e))
        ...
        var t = Ct[e.name];
        typeof t == "string" && (t = { name: t }), e = Wn(t, e), e.name = t.name;
      } else {
    ...
    function Un(e, t, i, r) {
      ...
      for (var o = i.state, a = function(u) {
        ...
        i.state = !0, Zn(e, t.text, f.mode, i, function(c, p) {
          for (var v = h; d < c; ) {
            var y = n[h];
    ...
    function Kn(e, t, i) {
      if (!t.styles || t.styles[0] != e.state.modeGen) {
        var r = jt(e, H(t)), n = t.text.length > e.options.maxHighlightLength && lt(e.doc.mode, r.state), l = Un(e, t, r);
    ...
    function jt(e, t, i) {
      ...
      if (!r.mode.startState)
        return new Ne(r, !0, t);
      var l = fa(e, t, i), o = l > r.first && w(r, l - 1).stateAfter, a = o ? Ne.fromSaved(r, o, l) : new Ne(r, Rn(r.mode), l);
    ...
    function Fi(e, t, i, r) {
      ...
      for (l.start = l.pos = r || 0, t == "" && _n(n, i.state); !l.eol(); )
    ...
    function Yn(e, t, i, r) {
      ...
      for (r && (f = []); (r || u.pos < t.ch) && !u.eol(); )
        u.start = u.pos, o = Pi(l, u, s.state), r && f.push(new Xn(u, o, lt(n.mode, s.state)));
      return r ? f : new Xn(u, o, s.state);
    }
    function qn(e, t) {
      if (e)
        for (; ; ) {
    ...
    function Zn(e, t, i, r, n, l, o) {
      ...
      for (t == "" && qn(_n(i, r.state), l); !f.eol(); ) {
        if (f.pos > e.options.maxHighlightLength ? (a = !1, o && Fi(e, t, r, f.pos), f.pos = t.length, h = null) : h = qn(Pi(i, f, r.state, d), l), d) {
          var c = d[0].name;
          c && (h = "m-" + (h ? c + " " + h : c));
        }
        if (!a || u != h) {
    ...
    function Ii(e, t) {
      ...
      if (i != 0)
        return i;
      var r = e.find(), n = t.find(), l = M(r.from, n.from) || Br(e) - Br(t);
      if (l)
        return -l;
      var o = M(r.to, n.to) || Rr(e) - Rr(t);
      return o || t.id - e.id;
    }
    function $n(e, t) {
    ...
    function tl(e, t, i, r, n) {
      var l = w(e, t), o = Pe && l.markedSpans;
      if (o)
        for (var a = 0; a < o.length; ++a) {
          var s = o[a];
          if (s.marker.collapsed) {
            var u = s.marker.find(0), f = M(u.from, i) || Br(s.marker) - Br(n), h = M(u.to, r) || Rr(s.marker) - Rr(n);
      ...
      if (i) {
        for (var r = void 0, n = 0; n < i.length; ++n)
          if (r = i[n], !!r.marker.collapsed) {
            if (r.from == null)
              return !0;
            if (!r.marker.widgetNode && r.from == 0 && r.marker.inclusiveLeft && Ri(e, t, r))
              return !0;
          }
      }
    }
    function Ri(e, t, i) {
      if (i.to == null) {
        ...
        return Ri(e, r.line, Vt(r.line.markedSpans, i.marker));
      }
      if (i.marker.inclusiveRight && i.to == t.text.length)
        return !0;
      for (var n = void 0, l = 0; l < t.markedSpans.length; ++l)
        if (n = t.markedSpans[l], n.marker.collapsed && !n.marker.widgetNode && n.from == i.to && (n.to == null || n.to != i.from) && (n.marker.inclusiveLeft || i.marker.inclusiveRight) && Ri(e, t, n))
          return !0;
    }
    function Ee(e) {
      e = Se(e);
    ...
    function Gr(e) {
      if (e.height == 0)
        return 0;
      for (var t = e.text.length, i, r = e; i = el(r); ) {
        var n = i.find(0, !0);
    ...
    var St = function(e, t, i) {
      this.text = e, Vn(this, t), this.height = i ? i(this) : 1;
    };
    St.prototype.lineNo = function() {
      return H(this);
    }, xt(St);
    function wa(e, t, i, r) {
      e.text = t, e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), e.order != null && (e.order = null), jn(e), Vn(e, i);
      var n = r ? r(e) : 1;
      n != e.height && De(e, n);
    }
    function Sa(e) {
    ...
    function nl(e, t) {
      ...
      for (var n = 0; n <= (t.rest ? t.rest.length : 0); n++) {
        ...
        Aa(l, r, Kn(e, l, a)), l.styleClasses && (l.styleClasses.bgClass && (r.bgClass = di(l.styleClasses.bgClass, r.bgClass || "")), l.styleClasses.textClass && (r.textClass = di(l.styleClasses.textClass, r.textClass || ""))), r.map.length == 0 && r.map.push(0, 0, r.content.appendChild(ta(e.display.measure))), n == 0 ? (t.measure.map = r.map, t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(r.map), (t.measure.caches || (t.measure.caches = [])).push({}));
      }
      if (ie) {
...
` ? (v = f.appendChild(k("span", d[0] == "\r" ? "␍" : "␤", "cm-invalidchar")), v.setAttribute("cm-text", d[0]), e.col += 1) : (v = e.cm.options.specialCharPlaceholder(d[0]), v.setAttribute("cm-text", d[0]), A && E < 9 ? f.appendChild(k("span", [v])) : f.appendChild(v), e.col += 1);
    ...
    function Aa(e, t, i) {
      ...
      if (!r) {
        for (var o = 1; o < i.length; o += 2)
          t.addToken(t, n.slice(l, l = i[o]), il(i[o + 1], t.cm.options));
        return;
      }
      for (var a = n.length, s = 0, u = 1, f = "", h, d, c = 0, p, v, y, m, x; ; ) {
        ...
        for (var de = Math.min(a, c); ; ) {
          ...
          f = n.slice(l, l = i[u++]), h = il(i[u++], t.cm.options);
        }
      }
    }
    function ol(e, t, i) {
    ...
    function Ur(e, t, i) {
      for (var r = [], n, l = t; l < i; l = n) {
        var o = new ol(e.doc, w(e.doc, l), l);
        n = l + o.size, r.push(o);
      }
      return r;
    }
    ...
    function al(e, t, i, r) {
      for (var n = 0; n < t.changes.length; n++) {
        var l = t.changes[n];
        l == "text" ? Ea(e, t) : l == "gutter" ? ul(e, t, i, r) : l == "class" ? Gi(e, t) : l == "widget" && Ia(e, t, r);
      }
      t.changes = null;
    }
    function er(e) {
    ...
    function sl(e, t) {
      ...
      return i && i.line == t.line ? (e.display.externalMeasured = null, t.measure = i.measure, i.built) : nl(e, t);
    }
    function Ea(e, t) {
      var i = t.text.className, r = sl(e, t);
    ...
    function Ba(e, t, i, r) {
      var n = sl(e, t);
      return t.text = t.node = n.pre, n.bgClass && (t.bgClass = n.bgClass), n.textClass && (t.textClass = n.textClass), Gi(e, t), ul(e, t, i, r), fl(e, t, r), t.node;
    }
    function fl(e, t, i) {
      if (hl(e, t.line, t, i, !0), t.rest)
        for (var r = 0; r < t.rest.length; r++)
          hl(e, t.rest[r], t, i, !1);
    }
    function hl(e, t, i, r, n) {
      if (t.widgets)
    ...
    function Ga(e, t) {
      t = Se(t);
      var i = H(t), r = e.display.externalMeasured = new ol(e.doc, t, i);
      r.lineN = i;
      var n = r.built = nl(e, r);
    ...
    function kt(e, t) {
      var i = H(t), r = _i(e, i);
      r && !r.text ? r = null : r && r.changes && (al(e, r, i, Qi(e)), e.curOp.forceUpdate = !0), r || (r = Ga(e, t));
      var n = dl(r, t, i);
      return {
        line: t,
        view: r,
    ...
    var vl = { left: 0, right: 0, top: 0, bottom: 0 };
    function gl(e, t, i) {
    ...
    function Ka(e, t, i, r) {
      var n = gl(t.map, i, r), l = n.node, o = n.start, a = n.end, s = n.collapse, u;
      if (l.nodeType == 3) {
        for (var f = 0; f < 4; f++) {
          ...
          for (; n.coverStart + a < n.coverEnd && bi(t.line.text.charAt(n.coverStart + a)); )
            ++a;
          if (A && E < 9 && o == 0 && a == n.coverEnd - n.coverStart ? u = l.parentNode.getBoundingClientRect() : u = Ua(rt(l, o, a).getClientRects(), r), u.left || u.right || o == 0)
            break;
          a = o, o = o - 1, s = "right";
        }
      ...
      if (A && E < 9 && !o && (!u || !u.left && !u.right)) {
        ...
        d ? u = { left: d.left, right: d.left + Mt(e.display), top: d.top, bottom: d.bottom } : u = vl;
      }
    ...
    function rr(e) {
      ml(e), e.display.cachedCharWidth = e.display.cachedTextHeight = e.display.cachedPaddingH = null, e.options.lineWrapping || (e.display.maxLineChanged = !0), e.display.lineNumChars = null;
    }
    function bl(e) {
    ...
    function _r(e, t, i, r, n) {
      ...
      if (r == "local" ? o += Kr(e.display) : o -= e.display.viewOffset, r == "page" || r == "window") {
        ...
        o += a.top + (r == "window" ? 0 : xl(we(e)));
        var s = a.left + (r == "window" ? 0 : bl(we(e)));
        i.left += s, i.right += s;
      }
    ...
    function Xr(e, t, i, r, n) {
      return r || (r = w(e.doc, t.line)), _r(e, r, pl(e, r, t.ch, n), i);
    }
    ...
    function Xa(e, t, i, r, n) {
      ...
      return p = Fn(t.text, p, 1), Yi(i, p, y, m, r - v);
    }
    ...
    function qa(e, t, i, r, n, l, o) {
      var a = Sl(e, t, r, o), s = a.begin, u = a.end;
    ...
    function ft(e, t, i, r) {
      ...
      if (r && s.xRel > 0 && (u = w(e.doc, s.line).text).length == s.ch) {
        ...
        s = g(s.line, Math.max(0, Math.round((l - cl(e.display).left) / Mt(e.display)) - f));
      }
      return s;
    }
    function ht(e, t) {
    ...
    function ae(e, t, i, r) {
      ...
      if (r && i < n.viewTo && (n.updateLineNumbers == null || n.updateLineNumbers > t) && (n.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= n.viewTo)
        Pe && Bi(e.doc, t) < n.viewTo && Ye(e);
      else if (i <= n.viewFrom)
        Pe && rl(e.doc, i + r) > n.viewFrom ? Ye(e) : (n.viewFrom += r, n.viewTo += r);
        ...
        if (!(!t && a == i.sel.primIndex)) {
          ...
          if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
            ...
            if (o) {
              var f = o(e, s);
              f && Vi(e, f, n);
            } else (u || e.options.showCursorWhenSelecting) && Vi(e, s.head, n);
            u || Qa(e, s, l);
          }
        }
      return r;
    ...
    function Qa(e, t, i) {
      var r = e.display, n = e.doc, l = document.createDocumentFragment(), o = cl(e.display), a = o.left, s = Math.max(r.sizerWidth, st(e) - r.sizer.offsetLeft) - o.right, u = n.direction == "ltr";
      function f(b, C, L, S) {
      ...
      function h(b, C, L) {
        ...
        function de(K, fe, V) {
          var X = Ll(e, S, null, K), _ = fe == "ltr" == (V == "after") ? "left" : "right", R = V == "after" ? X.begin : X.end - (/\s/.test(S.text.charAt(X.end - 1)) ? 2 : 1);
          return B(R, _)[_];
        }
        var ue = Fe(S, n.direction);
        return Vo(ue, C || 0, L ?? N, function(K, fe, V, X) {
          var _ = V == "ltr", R = B(K, _ ? "left" : "right"), he = B(fe - 1, _ ? "right" : "left"), zt = C == null && K == 0, Ve = L == null && fe == N, te = X == 0, We = !ue || X == ue.length - 1;
          if (he.top - R.top <= 3) {
            var j = (u ? zt : Ve) && te, kn = (u ? Ve : zt) && We, ze = j ? a : (_ ? R : he).left, gt = kn ? s : (_ ? he : R).right;
            f(ze, R.top, gt - ze, R.bottom);
          } else {
            var yt, le, Gt, Tn;
            _ ? (yt = u && zt && te ? a : R.left, le = u ? s : de(K, V, "before"), Gt = u ? a : de(fe, V, "after"), Tn = u && Ve && We ? s : he.right) : (yt = u ? de(K, V, "before") : a, le = !u && zt && te ? s : R.right, Gt = !u && Ve && We ? a : he.left, Tn = u ? de(fe, V, "after") : s), f(yt, R.top, le - yt, R.bottom), R.bottom < he.top && f(a, R.bottom, null, he.top), f(Gt, he.top, Tn - Gt, he.bottom);
          }
          (!P || qr(R, P) < 0) && (P = R), qr(he, P) < 0 && (P = he), (!J || qr(R, J) < 0) && (J = R), qr(he, J) < 0 && (J = he);
        }), { start: P, end: J };
      }
      var d = t.from(), c = t.to();
      if (d.line == c.line)
    ...
    function Zr(e) {
      for (var t = e.display, i = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), n = t.lineDiv.getBoundingClientRect().top, l = 0, o = 0; o < t.view.length; o++) {
        ...
        if (!a.hidden) {
          ...
          if ((c > 5e-3 || c < -5e-3) && (n < r && (l -= c), De(a.line, u), Nl(a.line), a.rest))
    ...
    function lr(e, t) {
      Math.abs(e.doc.scrollTop - t) < 2 || (He || on(e, { top: t }), Ol(e, t, !0), He && on(e), sr(e, 100));
    }
    function Ol(e, t, i) {
    ...
    function ct(e, t, i, r) {
      t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth)), !((i ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r) && (e.doc.scrollLeft = t, El(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t));
    }
    function or(e) {
    ...
    function At(e, t) {
      ...
      for (var n = 0; n < 4 && i != e.display.barWidth || r != e.display.barHeight; n++)
        i != e.display.barWidth && e.options.lineWrapping && Zr(e), Wl(e, or(e)), i = e.display.barWidth, r = e.display.barHeight;
    }
    function Wl(e, t) {
    ...
    var Hl = { native: dt, null: ar };
    function Fl(e) {
      e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && tt(e.display.wrapper, e.display.scrollbars.addClass)), e.display.scrollbars = new Hl[e.options.scrollbarStyle](function(t) {
    ...
    function ls(e) {
      ...
      e.preparedSelection && t.display.input.showSelection(e.preparedSelection, i), (e.updatedDisplay || e.startHeight != t.doc.height) && At(t, e.barMeasure), e.updatedDisplay && sn(t, e.barMeasure), e.selectionChanged && $i(t), t.state.focused && e.updateInput && t.display.input.reset(e.typing), i && Dl(e.cm);
    }
    function os(e) {
      var t = e.cm, i = t.display, r = t.doc;
      if (e.updatedDisplay && Pl(t, e.update), i.wheelStartX != null && (e.scrollTop != null || e.scrollLeft != null || e.scrollToPos) && (i.wheelStartX = i.wheelStartY = null), e.scrollTop != null && Ol(t, e.scrollTop, e.forceScroll), e.scrollLeft != null && ct(t, e.scrollLeft, !0, !0), e.scrollToPos) {
        var n = ja(
          t,
      ...
      if (!(t.highlightFrontier >= e.display.viewTo)) {
        ...
        t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(l) {
          if (r.line >= e.display.viewFrom) {
            var o = l.styles, a = l.text.length > e.options.maxHighlightLength ? lt(t.mode, r.state) : null, s = Un(e, l, r, !0);
    ...
    function ln(e, t) {
      ...
      if (t.editorIsHidden)
        return Ye(e), !1;
      if (!t.force && t.visible.from >= i.viewFrom && t.visible.to <= i.viewTo && (i.updateLineNumbers == null || i.updateLineNumbers >= i.viewTo) && i.renderedView == i.view && Tl(e) == 0)
        return !1;
      Il(e) && (Ye(e), t.dims = Qi(e));
      ...
      i.viewFrom < l && l - i.viewFrom < 20 && (l = Math.max(r.first, i.viewFrom)), i.viewTo > o && i.viewTo - o < 20 && (o = Math.min(n, i.viewTo)), Pe && (l = Bi(e.doc, l), o = rl(e.doc, o));
    ...
    function hs(e, t, i) {
      ...
      for (var s = r.view, u = r.viewFrom, f = 0; f < s.length; f++) {
        ...
        if (!h.hidden) if (!h.node || h.node.parentNode != l) {
          ...
          h.changes && ($(h.changes, "gutter") > -1 && (c = !1), al(e, h, u, i)), c && (Ge(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(Oi(e.options, u)))), o = h.node.nextSibling;
        }
        u += h.size;
      }
      for (; o; )
    ...
    var Vr = 0, Be = null;
    A ? Be = -0.53 : He ? Be = 15 : $e ? Be = -0.7 : Tr && (Be = -1 / 3);
    function Rl(e) {
    ...
    function zl(e, t) {
      $e && _o == 102 && (e.display.chromeScrollHack == null ? e.display.sizer.style.pointerEvents = "none" : clearTimeout(e.display.chromeScrollHack), e.display.chromeScrollHack = setTimeout(function() {
        e.display.chromeScrollHack = null, e.display.sizer.style.pointerEvents = "";
      }, 100));
      var i = Rl(t), r = i.x, n = i.y, l = Be;
      ...
      if (r && s || n && u) {
        ...
        Vr < 20 && t.deltaMode !== 0 && (o.wheelStartX == null ? (o.wheelStartX = a.scrollLeft, o.wheelStartY = a.scrollTop, o.wheelDX = r, o.wheelDY = n, setTimeout(function() {
          if (o.wheelStartX != null) {
            ...
            o.wheelStartX = o.wheelStartY = null, x && (Be = (Be * Vr + x) / (Vr + 1), ++Vr);
          }
    ...
    function ps(e, t, i) {
      for (var r = [], n = g(e.first, 0), l = n, o = 0; o < t.length; o++) {
        var a = t[o], s = Ul(a.from, n, l), u = Ul(Ze(a), n, l);
    ...
    function _l(e, t) {
      ...
      e.doc = t, t.cm = e, ji(e), hn(e), Xl(e), e.options.direction = t.direction, e.options.lineWrapping || zi(e), e.options.mode = t.modeOption, ae(e);
    }
    function Xl(e) {
    ...
    function dn(e, t) {
      ...
      return Zl(e, i, t.from.line, t.to.line + 1), Qe(e, function(r) {
        return Zl(r, i, t.from.line, t.to.line + 1);
      }, !0), i;
    }
    function Yl(e) {
      for (; e.length; ) {
    ...
    function ms(e, t, i, r) {
      ...
      i == n.lastSelOp || l && n.lastSelOrigin == l && (n.lastModTime == n.lastSelTime && n.lastOrigin == l || ys(e, l, W(n.done), t)) ? n.done[n.done.length - 1] = t : ei(t, n.done), n.lastSelTime = +/* @__PURE__ */ new Date(), n.lastSelOrigin = l, n.lastSelOp = i, r && r.clearRedo !== !1 && Yl(n.undone);
    }
    function ei(e, t) {
      var i = W(t);
    ...
    function ri(e, t, i) {
      ...
      $l(e, to(e, t, r, !0)), !(i && i.scroll === !1) && e.cm && e.cm.getOption("readOnly") != "nocursor" && Nt(e.cm);
    }
    function $l(e, t) {
      t.equals(e.sel) || (e.sel = t, e.cm && (e.cm.curOp.updateInput = 1, e.cm.curOp.selectionChanged = !0, En(e.cm)), q(e, "cursorActivity", e));
    }
    function eo(e) {
      $l(e, to(e, e.sel, null, !1));
    }
    function to(e, t, i, r) {
        ...
        for (var o = 0; o < l.markedSpans.length; ++o) {
          ...
          if ((a.from == null || (u ? a.from <= t.ch : a.from < t.ch)) && (a.to == null || (f ? a.to >= t.ch : a.to > t.ch))) {
            ...
            if (i) {
              ...
              if ((r < 0 ? f : u) && (h = ro(e, h, -r, h && h.line == t.line ? l : null)), h && h.line == t.line && (d = M(h, i)) && (r < 0 ? d < 0 : d > 0))
                return Wt(e, h, t, r, n);
            }
            var c = s.find(r < 0 ? -1 : 1);
            return (r < 0 ? u : f) && (c = ro(e, c, r, c.line == t.line ? l : null)), c ? Wt(e, c, t, r, n) : null;
          }
        }
      return t;
    }
    ...
    function Ht(e, t, i) {
      ...
      if (!((xe(e, "beforeChange") || e.cm && xe(e.cm, "beforeChange")) && (t = no(e, t, !0), !t))) {
        var r = Qn && !i && ma(e, t.from, t.to);
        if (r)
          for (var n = r.length - 1; n >= 0; --n)
            lo(e, { from: r[n].from, to: r[n].to, text: n ? [""] : t.text, origin: t.origin });
        else
          lo(e, t);
      }
    }
    function lo(e, t) {
      if (!(t.text.length == 1 && t.text[0] == "" && M(t.from, t.to) == 0)) {
        ...
        var r = [];
        Qe(e, function(n, l) {
          !l && $(r, n.history) == -1 && (uo(n.history, t), r.push(n.history)), hr(n, t, null, Ei(n, t));
        });
      }
    }
    function ni(e, t, i) {
      ...
      if (!(r && !i)) {
        ...
        if (u != a.length) {
          ...
          for (var h = xe(e, "beforeChange") || e.cm && xe(e.cm, "beforeChange"), d = function(v) {
            var y = l.changes[v];
            if (y.origin = t, h && !no(e, y, !1))
              return a.length = 0, {};
            f.push(dn(e, y));
            var m = v ? fn(e, y) : W(a);
            hr(e, y, m, Ql(e, y)), !v && e.cm && e.cm.scrollIntoView({ from: y.from, to: Ze(y) });
            var x = [];
            Qe(e, function(b, C) {
              !C && $(x, b.history) == -1 && (uo(b.history, y), x.push(b.history)), hr(b, y, null, Ql(b, y));
            });
    ...
    function hr(e, t, i, r) {
      ...
      if (!(t.from.line > e.lastLine())) {
        ...
        t.to.line > l && (t = {
          ...
          text: [t.text[0]],
          origin: t.origin
        }), t.removed = ot(e, t.from, t.to), i || (i = fn(e, t)), e.cm ? ws(e.cm, t, r) : cn(e, t, r), ri(e, i, Me), e.cantEdit && ii(e, g(e.firstLine(), 0)) && (e.cantEdit = !1);
      }
    }
    function ws(e, t, i) {
      ...
      e.options.lineWrapping || (s = H(Se(w(r, l.line))), r.iter(s, o.line + 1, function(c) {
        if (c == n.maxLine)
          return a = !0, !0;
      })), r.sel.contains(t.from, t.to) > -1 && En(e), cn(r, t, i, kl(e)), e.options.lineWrapping || (r.iter(s, l.line + t.text.length, function(c) {
        var p = Gr(c);
      ...
      t.full ? ae(e) : l.line == o.line && t.text.length == 1 && !Kl(e.doc, t) ? Xe(e, l.line, "text") : ae(e, l.line, o.line + 1, u);
      ...
      for (var n = 0; n < e.length; ++n) {
        ...
        if (l.ranges) {
          ...
          for (var a = 0; a < l.ranges.length; a++)
            ao(l.ranges[a].anchor, t, i, r), ao(l.ranges[a].head, t, i, r);
          continue;
        }
    ...
    function uo(e, t) {
      ...
      so(e.done, i, r, n), so(e.undone, i, r, n);
    }
    function cr(e, t, i, r) {
      var n = t, l = t;
      return typeof t == "number" ? l = w(e, zn(e, t)) : n = H(t), n == null ? null : (r(l, n) && e.cm && Xe(e.cm, n, i), l);
    }
    function dr(e) {
    ...
    vr.prototype.clear = function() {
      ...
      n && (_e(this.doc, r) || De(r, r.height + n), i && ce(i, function() {
        i.curOp.forceUpdate = !0, fo(i, r, n), q(i, "lineWidgetChanged", i, e, H(r));
      }));
    }, xt(vr);
    function fo(e, t, i) {
    ...
    Je.prototype.clear = function() {
      if (!this.explicitlyCleared) {
        ...
        for (var r = null, n = null, l = 0; l < this.lines.length; ++l) {
          ...
          e && !this.collapsed ? Xe(e, H(o), "text") : e && (a.to != null && (n = H(o)), a.from != null && (r = H(o))), o.markedSpans = pa(o.markedSpans, a), a.from == null && this.collapsed && !_e(this.doc, o) && e && De(o, Tt(e.display));
        }
        ...
        r != null && e && this.collapsed && ae(e, r, n + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && eo(e.doc)), e && q(e, "markerCleared", e, this, r, n), t && vt(e), this.parent && this.parent.clear();
      }
      ...
      !t || !r || ce(r, function() {
        ...
        if (o && (yl(o), r.curOp.selectionChanged = r.curOp.forceUpdate = !0), r.curOp.updateMaxLine = !0, !_e(i.doc, n) && i.height != null) {
          var a = i.height;
          i.height = null;
          var s = tr(i) - a;
          s && De(n, n.height + s);
    ...
    function Pt(e, t, i, r, n) {
      ...
      if (l.replacedWith && (l.collapsed = !0, l.widgetNode = bt("span", [l.replacedWith], "CodeMirror-widget"), r.handleMouseEvents || l.widgetNode.setAttribute("cm-ignore-events", "true"), r.insertLeft && (l.widgetNode.insertLeft = !0)), l.collapsed) {
        if (tl(e, t.line, t, i, l) || t.line != i.line && tl(e, i.line, t, i, l))
      ...
      if (e.iter(a, i.line + 1, function(h) {
        s && l.collapsed && !s.options.lineWrapping && Se(h) == s.display.maxLine && (u = !0), l.collapsed && a != t.line && De(h, 0), va(h, new Ir(
          l,
          a == t.line ? t.ch : null,
          a == i.line ? i.ch : null
        ), e.cm && e.cm.curOp), ++a;
        ...
        return l.clear();
      }), l.readOnly && (ca(), (e.history.done.length || e.history.undone.length) && e.clearHistory()), l.collapsed && (l.id = ++ho, l.atomic = !0), s) {
        if (u && (s.curOp.updateMaxLine = !0), l.collapsed)
          ...
          for (var f = t.line; f <= i.line; f++)
            Xe(s, f, "text");
        l.atomic && eo(s.doc), q(s, "markerAdded", s, l);
      }
      return l;
    }
    var gr = function(e, t) {
    ...
    var Ms = 0, se = function(e, t, i, r, n) {
      ...
      var l = g(i, 0);
      this.sel = qe(l), this.history = new $r(null), this.id = ++Ms, this.modeOption = t, this.lineSep = r, this.direction = n == "rtl" ? "rtl" : "ltr", this.extend = !1, typeof e == "string" && (e = this.splitLines(e)), cn(this, { from: l, to: l, text: e }), ee(this, qe(l), Me);
    };
    se.prototype = Wn(pr.prototype, {
      constructor: se,
      ...
      setCursor: Q(function(e, t, i) {
        jl(this, D(this, typeof e == "number" ? g(e, t || 0) : e), null, i);
      }),
      setSelection: Q(function(e, t, i) {
        jl(this, D(this, e), D(this, t || e), i);
      }),
      ...
      replaceSelections: Q(function(e, t, i) {
        ...
        for (var a = t && t != "end" && ps(this, r, t), s = r.length - 1; s >= 0; s--)
          Ht(this, r[s]);
        a ? Vl(this, a) : this.cm && Nt(this.cm);
      }),
      undo: Q(function() {
        ni(this, "undo");
      }),
      ...
      setGutterMarker: Q(function(e, t, i) {
        return cr(this, e, "gutter", function(r) {
          ...
          return n[t] = i, !i && Hn(n) && (r.gutterMarkers = null), !0;
        });
      }),
      clearGutter: Q(function(e) {
        ...
        this.iter(function(i) {
          i.gutterMarkers && i.gutterMarkers[e] && cr(t, i, "gutter", function() {
            return i.gutterMarkers[e] = null, Hn(i.gutterMarkers) && (i.gutterMarkers = null), !0;
          });
        });
      }),
      lineInfo: function(e) {
      ...
      linkedDoc: function(e) {
        ...
        return e.sharedHist && (r.history = this.history), (this.linked || (this.linked = [])).push({ doc: r, sharedHist: e.sharedHist }), r.linked = [{ doc: this, isParent: !0, sharedHist: e.sharedHist }], ks(r, co(this)), r;
      },
      unlinkDoc: function(e) {
        if (e instanceof I && (e = e.doc), this.linked)
          for (var t = 0; t < this.linked.length; ++t) {
            var i = this.linked[t];
            if (i.doc == e) {
              this.linked.splice(t, 1), e.unlinkDoc(this), Ts(co(this));
              break;
            }
          }
...
`;
    ...
    function Ds(e) {
      var t = this;
      if (vo(t), !(Y(t, e) || Ie(t.display, e))) {
        oe(e), A && (po = +/* @__PURE__ */ new Date());
          ...
          if (r && r.length && window.FileReader && window.File)
            for (var n = r.length, l = Array(n), o = 0, a = function() {
              ++o == n && Z(t, function() {
                ...
                Ht(t.doc, c), Vl(t.doc, qe(D(t.doc, i), D(t.doc, Ze(c))));
              })();
            }, s = function(c, p) {
    ...
    function Ns(e, t) {
      if (A && (!e.state.draggingText || +/* @__PURE__ */ new Date() - po < 100)) {
        Qt(t);
        return;
      }
    ...
    function bo(e, t, i) {
      var r = e;
      return t.altKey && r != "Alt" && (e = "Alt-" + e), (Nn ? t.metaKey : t.ctrlKey) && r != "Ctrl" && (e = "Ctrl-" + e), (Nn ? t.ctrlKey : t.metaKey) && r != "Mod" && (e = "Cmd-" + e), !i && t.shiftKey && r != "Shift" && (e = "Shift-" + e), e;
    }
    function xo(e, t) {
      if (Ce && e.keyCode == 34 && e.char)
        return !1;
      var i = je[e.keyCode];
      return i == null || e.altGraphKey ? !1 : (e.keyCode == 3 && e.code && (i = e.code), bo(i, e, t));
    }
    function oi(e) {
    ...
    function Es(e, t, i, r) {
      ...
      var a = function(m, x) {
        ...
        return e.options.lineWrapping ? (s = s || kt(e, t), Ll(e, t, s, m)) : { begin: 0, end: t.text.length };
...
`, "start");
    ...
    function wo(e, t) {
      var i = Co(e, t.line), r = w(e.doc, i.line), n = Fe(r, e.doc.direction);
      if (!n || n[0].level == 0) {
    ...
    function ko(e) {
      ...
      if (!(e.target && e.target != t.display.input.getField()) && (t.curOp.focus = me(we(t)), !Y(t, e))) {
        ...
        var r = Lo(t, e);
        Ce && (bn = r ? i : null, !r && i == 88 && !na && (ye ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")), He && !ye && !r && i == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"), i == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && Gs(t);
      }
    }
    function Gs(e) {
    ...
    function Do(e) {
      ...
      if (!(Y(t, e) || i.activeTouch && i.input.supportsTouch())) {
        ...
        if (!Cn(t, e)) {
          var r = ft(t, e), n = Bn(e), l = r ? Ks(r, n) : "single";
          Dr(t).focus(), n == 1 && t.state.selectingText && t.state.selectingText(e), !(r && _s(t, n, r, l, e)) && (n == 1 ? r ? Ys(t, r, l, e) : wi(e) == i.scroller && oe(e) : n == 2 ? (r && ti(t.doc, r), setTimeout(function() {
    ...
    function _s(e, t, i, r, n) {
      var l = "Click";
      return r == "double" ? l = "Double" + l : r == "triple" && (l = "Triple" + l), l = (t == 1 ? "Left" : t == 2 ? "Middle" : "Right") + l, xr(e, bo(l, n), n, function(o) {
    ...
    function Ys(e, t, i, r) {
      A ? setTimeout(pi(Dl, e), 0) : e.curOp.focus = me(we(e));
        ...
        if (M(h, b) != 0)
          if (h = b, r.unit == "rectangle") {
            for (var C = [], L = e.options.tabSize, S = be(w(l, i.line).text, i.ch, L), N = be(w(l, b.line).text, b.ch, L), P = Math.min(S, N), J = Math.max(S, N), B = Math.min(i.line, b.line), de = Math.min(e.lastLine(), Math.max(i.line, b.line)); B <= de; B++) {
              var ue = w(l, B).text, K = gi(ue, P, L);
              P == J ? C.push(new O(g(B, K), g(B, K))) : ue.length > K && C.push(new O(g(B, K), g(B, gi(ue, J, L))));
            }
    ...
    function js(e) {
      ...
      e.defineOption = i, e.Init = Bt, i("value", "", function(r, n) {
        return r.setValue(n);
        ...
        r.state.specialChars = new RegExp(n.source + (n.test("	") ? "" : "|	"), "g"), l != Bt && r.refresh();
        ...
        Fl(r), At(r), r.display.scrollbars.setScrollTop(r.doc.scrollTop), r.display.scrollbars.setScrollLeft(r.doc.scrollLeft);
    ...
    function I(e, t) {
      ...
      if (!(this instanceof I))
        return new I(e, t);
      this.options = t = t ? nt(t) : {}, nt(Ho, t, !1);
      var r = t.value;
      ...
      l.wrapper.CodeMirror = this, Wo(this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Fl(this), this.state = {
        keyMaps: [],
      ...
      }, 20), eu(this), Os(), pt(this), this.curOp.forceUpdate = !0, _l(this, r), t.autofocus && !Kt || this.hasFocus() ? setTimeout(function() {
        i.hasFocus() && !i.state.focused && tn(i);
      }, 20) : Dt(this);
      for (var o in si)
        si.hasOwnProperty(o) && si[o](this, t[o], Bt);
    ...
    I.defaults = Ho, I.optionHandlers = si;
    function eu(e) {
      var t = e.display;
      T(t.scroller, "mousedown", Z(e, Do)), A && E < 11 ? T(t.scroller, "dblclick", Z(e, function(s) {
        if (!Y(e, s)) {
          var u = ft(e, s);
        ...
        t.scroller.contains(s.target) || Oo(e, s);
      });
      var i, r = { end: 0 };
      function n() {
      ...
      T(a, "keyup", function(s) {
        return To.call(e, s);
      }), T(a, "keydown", Z(e, ko)), T(a, "keypress", Z(e, Mo)), T(a, "focus", function(s) {
        return tn(e, s);
      }), T(a, "blur", function(s) {
        return Dt(e, s);
      });
    ...
    function Sn(e, t, i, r, n) {
      ...
      var o = +/* @__PURE__ */ new Date() - 200, a = n == "paste" || e.state.pasteIncoming > o, s = ki(t), u = null;
...
`) == t) {
        ...
        } else s.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = Or(s, function(m) {
          return [m];
        }));
...
`) && (p = v = g(p.line, 0)));
      ...
      t && !a && Po(e, t), Nt(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = h), e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = -1;
    }
    function Fo(e, t) {
      ...
      if (!(!e.options.electricChars || !e.options.smartIndent))
        for (var i = e.doc.sel, r = i.ranges.length - 1; r >= 0; r--) {
          ...
          if (!(n.head.ch > 100 || r && i.ranges[r - 1].head.line == n.head.line)) {
            ...
            } else l.electricInput && l.electricInput.test(w(e.doc, n.head.line).text.slice(0, n.head.ch)) && (o = Sr(e, n.head.line, "smart"));
    ...
    function Bo() {
      ...
      return ie ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), Ut && (e.style.border = "1px solid black"), Io(e), t;
    }
    function tu(e) {
      ...
      e.prototype = {
        ...
        getLineTokens: function(r, n) {
          return Yn(this, g(r), n, !0);
        },
        getTokenTypeAt: function(r) {
          r = D(this.doc, r);
          var n = Kn(this, w(this.doc, r.line)), l = 0, o = (n.length - 1) / 2, a = r.ch, s;
          if (a == 0)
            s = n[2];
          else
            for (; ; ) {
        ...
        getStateAfter: function(r, n) {
          var l = this.doc;
          return r = zn(l, r ?? l.first + l.size - 1), jt(this, r + 1, n).state;
        },
        ...
        coordsChar: function(r, n) {
          return r = Cl(this, r, n || "page"), qi(this, r.left, r.top);
        },
        lineAtHeight: function(r, n) {
          return r = Cl(this, { top: r, left: 0 }, n || "page").top, at(this.doc, r + this.display.viewOffset);
        },
        ...
        triggerOnKeyDown: ne(ko),
        triggerOnKeyPress: ne(Mo),
        triggerOnKeyUp: To,
        triggerOnMouseDown: ne(Do),
        ...
        findPosV: function(r, n, l, o) {
          ...
          for (var u = D(this.doc, r), f = 0; f < n; ++f) {
            var h = Le(this, u, "div");
            if (s == null ? s = h.left : h.left = s, u = Ro(this, h, a, l), u.hitSide)
              break;
          }
          return u;
        },
        ...
        scrollIntoView: ne(function(r, n) {
          r == null ? (r = { from: this.doc.sel.primary().head, to: null }, n == null && (n = this.options.cursorScrollMargin)) : typeof r == "number" ? r = { from: g(r, 0), to: null } : r.from == null && (r = { from: r, to: null }), r.to || (r.to = r.from), r.margin = n || 0, r.from.line != null ? $a(this, r) : Al(this, r.from, r.to, r.margin);
        }),
        setSize: ne(function(r, n) {
          var l = this, o = function(s) {
            return typeof s == "number" || /^\d+$/.test(String(s)) ? s + "px" : s;
          };
          r != null && (this.display.wrapper.style.width = o(r)), n != null && (this.display.wrapper.style.height = o(n)), this.options.lineWrapping && ml(this);
        ...
        swapDoc: ne(function(r) {
          var n = this.doc;
          return n.cm = null, this.state.selectingText && this.state.selectingText(), _l(this, r), rr(this), this.display.input.reset(), nr(this, r.scrollLeft, r.scrollTop), this.curOp.forceScroll = !0, q(this, "swapDoc", this, n), n;
        }),
        phrase: function(r) {
    ...
    function Ln(e, t, i, r, n) {
      ...
      function f(x) {
        ...
        } else n ? b = Es(e.cm, a, t, i) : b = yn(a, t, i);
        if (b == null)
          if (!x && u())
...
` ? "n" : !d || /\s/.test(v) ? null : "p";
    ...
    F.prototype.init = function(e) {
      ...
      n.contentEditable = !0, Io(n, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize);
      function l(a) {
      ...
      T(n, "paste", function(a) {
        !l(a) || Y(r, a) || Fo(a, r) || E <= 11 && setTimeout(Z(r, function() {
...
`);
      ...
      if (!(l && !l.bad && o && !o.bad && M(Pr(l, o), r) == 0 && M(Fr(l, o), n) == 0)) {
        var a = t.display.view, s = r.line >= t.display.viewFrom && zo(t, r) || { node: a[0].measure.map[2], offset: 0 }, u = n.line < t.display.viewTo && zo(t, n);
        if (!u) {
      ...
      if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
        ...
        if (Mr && $e && this.cm.display.gutterSpecs.length && ru(e.anchorNode)) {
      ...
      if (s == t.view.length - 1 ? (u = t.viewTo - 1, f = t.lineDiv.lastChild) : (u = H(t.view[s + 1].line) - 1, f = t.view[s + 1].node.previousSibling), !a)
        return !1;
      for (var h = e.doc.splitLines(iu(e, a, f, o, u)), d = ot(e.doc, g(o, 0), g(u, w(e.doc, u).text.length)); h.length > 1 && d.length > 1; )
        if (W(h) == W(d))
          h.pop(), d.pop(), u--;
        else if (h[0] == d[0])
          h.shift(), d.shift(), o++;
    ...
    function zo(e, t) {
      ...
      if (!i || i.hidden)
        return null;
      var r = w(e.doc, t.line), n = dl(i, r, t.line), l = Fe(r, e.doc.direction), o = "left";
      if (l) {
        var a = Zt(l, t.ch);
        o = a % 2 ? "right" : "left";
      }
      var s = gl(n.map, t.ch, o);
    ...
    function fi(e, t, i) {
      ...
      if (t == e.display.lineDiv) {
        if (r = e.display.lineDiv.childNodes[i], !r)
          return Rt(e.clipPos(g(e.display.viewTo - 1)), !0);
        t = null, i = 0;
      } else
    ...
    z.prototype.init = function(e) {
      ...
      e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild), Ut && (n.style.width = "0px"), T(n, "input", function() {
        ...
        Y(r, o) || Fo(o, r) || (r.state.pasteIncoming = +/* @__PURE__ */ new Date(), i.fastPoll());
      });
      function l(o) {
        if (!Y(r, o)) {
          if (r.somethingSelected())
...
`) > -1 ? i.value = e.prevInput = "" : e.prevInput = n, e.composing && (e.composing.range.clear(), e.composing.range = t.markText(
      ...
      function c() {
        if (t.contextMenuPending == c && (t.contextMenuPending = !1, t.wrapper.style.cssText = u, n.style.cssText = s, A && E < 9 && r.scrollbars.setScrollTop(r.scroller.scrollTop = o), n.selectionStart != null)) {
          (!A || A && E < 9) && d();
          var v = 0, y = function() {
            r.selForContextMenu == i.doc.sel && n.selectionStart == 0 && n.selectionEnd > 0 && t.prevInput == "​" ? Z(i, io)(i) : v++ < 10 ? r.detectingSelectAll = setTimeout(y, 500) : (r.selForContextMenu = null, r.input.reset());
          };
    ...
    function ou(e) {
      e.off = ve, e.on = T, e.wheelEventPixels = ds, e.Doc = se, e.splitLines = ki, e.countColumn = be, e.findColumn = gi, e.isWordChar = mi, e.Pass = Nr, e.signal = G, e.Line = St, e.changeEnd = Ze, e.scrollbarModel = Hl, e.Pos = g, e.cmpPos = M, e.modes = Mi, e.mimeModes = Ct, e.resolveMode = Hr, e.getMode = Di, e.modeExtensions = wt, e.extendMode = sa, e.copyState = lt, e.startState = Rn, e.innerMode = Ni, e.commands = br, e.keyMap = Re, e.keyName = xo, e.isModifierKey = mo, e.lookupKey = Et, e.normalizeKeyMap = Ps, e.StringStream = U, e.SharedTextMarker = gr, e.TextMarker = Je, e.LineWidget = vr, e.e_preventDefault = oe, e.e_stopPropagation = In, e.e_stop = Qt, e.addClass = it, e.contains = Ue, e.rmClass = tt, e.keyNames = je;
    }
    js(I), tu(I);
    var au = "iter insert remove copy getEditor constructor".split(" ");
    for (var hi in se.prototype)
      se.prototype.hasOwnProperty(hi) && $(au, hi) < 0 && (I.prototype[hi] = /* @__PURE__ */ function(e) {
        return function() {
