(function ($) {
    ...
    perfreeComment.prototype = {
        options: {
            ...
            // 表情包资源
            emjoiList: [
                {"url":"/static/public/libs/perfree-comment/imgs/aini.png","id":"aini"},
                {"url":"/static/public/libs/perfree-comment/imgs/baibai.png","id":"baibai"},
                {"url":"/static/public/libs/perfree-comment/imgs/baiyan.png","id":"baiyan"},
                {"url":"/static/public/libs/perfree-comment/imgs/baobao.png","id":"baobao"},
                {"url":"/static/public/libs/perfree-comment/imgs/beishang.png","id":"beishang"},
                {"url":"/static/public/libs/perfree-comment/imgs/bingbujiandan.png","id":"bingbujiandan"},
                {"url":"/static/public/libs/perfree-comment/imgs/bishi.png","id":"bishi"},
                {"url":"/static/public/libs/perfree-comment/imgs/bizui.png","id":"bizui"},
                {"url":"/static/public/libs/perfree-comment/imgs/chanzui.png","id":"chanzui"},
                {"url":"/static/public/libs/perfree-comment/imgs/chigua.png","id":"chigua"},
                {"url":"/static/public/libs/perfree-comment/imgs/chijing.png","id":"chijing"},
                {"url":"/static/public/libs/perfree-comment/imgs/chongjing.png","id":"chongjing"},
                {"url":"/static/public/libs/perfree-comment/imgs/dalian.png","id":"dalian"},
                {"url":"/static/public/libs/perfree-comment/imgs/ding.png","id":"ding"},
                {"url":"/static/public/libs/perfree-comment/imgs/doge.png","id":"doge"},
                {"url":"/static/public/libs/perfree-comment/imgs/erha.png","id":"erha"},
                {"url":"/static/public/libs/perfree-comment/imgs/feijie.png","id":"feijie"},
                {"url":"/static/public/libs/perfree-comment/imgs/ganbei.png","id":"ganbei"},
                {"url":"/static/public/libs/perfree-comment/imgs/ganmao.png","id":"ganmao"},
                {"url":"/static/public/libs/perfree-comment/imgs/geili.png","id":"geili"},
                {"url":"/static/public/libs/perfree-comment/imgs/geinixiaoxinxin.png","id":"geinixiaoxinxin"},
                {"url":"/static/public/libs/perfree-comment/imgs/good.png","id":"good"},
                {"url":"/static/public/libs/perfree-comment/imgs/guile.png","id":"guile"},
                {"url":"/static/public/libs/perfree-comment/imgs/guzhang.png","id":"guzhang"},
                {"url":"/static/public/libs/perfree-comment/imgs/haixiu.png","id":"haixiu"},
                {"url":"/static/public/libs/perfree-comment/imgs/han.png","id":"han"},
                {"url":"/static/public/libs/perfree-comment/imgs/haqian.png","id":"haqian"},
                {"url":"/static/public/libs/perfree-comment/imgs/heixian.png","id":"heixian"},
                {"url":"/static/public/libs/perfree-comment/imgs/heng.png","id":"heng"},
                {"url":"/static/public/libs/perfree-comment/imgs/huaixiao.png","id":"huaixiao"},
                {"url":"/static/public/libs/perfree-comment/imgs/hufen.png","id":"hufen"},
                {"url":"/static/public/libs/perfree-comment/imgs/jiayou.png","id":"jiayou"},
                {"url":"/static/public/libs/perfree-comment/imgs/jiyan.png","id":"jiyan"},
                {"url":"/static/public/libs/perfree-comment/imgs/keai.png","id":"keai"},
                {"url":"/static/public/libs/perfree-comment/imgs/kelian.png","id":"kelian"},
                {"url":"/static/public/libs/perfree-comment/imgs/ku.png","id":"ku"},
                {"url":"/static/public/libs/perfree-comment/imgs/kun.png","id":"kun"},
                {"url":"/static/public/libs/perfree-comment/imgs/lai.png","id":"lai"},
                {"url":"/static/public/libs/perfree-comment/imgs/lei.png","id":"lei"},
                {"url":"/static/public/libs/perfree-comment/imgs/NO.png","id":"NO"},
                {"url":"/static/public/libs/perfree-comment/imgs/nu.png","id":"nu"},
                {"url":"/static/public/libs/perfree-comment/imgs/numa.png","id":"numa"},
                {"url":"/static/public/libs/perfree-comment/imgs/ok.png","id":"ok"},
                {"url":"/static/public/libs/perfree-comment/imgs/qian.png","id":"qian"},
                {"url":"/static/public/libs/perfree-comment/imgs/qinqin.png","id":"qinqin"},
                {"url":"/static/public/libs/perfree-comment/imgs/quantou.png","id":"quantou"},
                {"url":"/static/public/libs/perfree-comment/imgs/se.png","id":"se"},
                {"url":"/static/public/libs/perfree-comment/imgs/shangxin.png","id":"shangxin"},
                {"url":"/static/public/libs/perfree-comment/imgs/shayan.png","id":"shayan"},
                {"url":"/static/public/libs/perfree-comment/imgs/shengbing.png","id":"shengbing"},
                {"url":"/static/public/libs/perfree-comment/imgs/shiwang.png","id":"shiwang"},
                {"url":"/static/public/libs/perfree-comment/imgs/shuai.png","id":"shuai"},
                {"url":"/static/public/libs/perfree-comment/imgs/shui.png","id":"shui"},
                {"url":"/static/public/libs/perfree-comment/imgs/sikao.png","id":"sikao"},
                {"url":"/static/public/libs/perfree-comment/imgs/taikaixin.png","id":"taikaixin"},
                {"url":"/static/public/libs/perfree-comment/imgs/taiyang.png","id":"taiyang"},
                {"url":"/static/public/libs/perfree-comment/imgs/tanshou.png","id":"tanshou"},
                {"url":"/static/public/libs/perfree-comment/imgs/tianping.png","id":"tianping"},
                {"url":"/static/public/libs/perfree-comment/imgs/touxiao.png","id":"touxiao"},
                {"url":"/static/public/libs/perfree-comment/imgs/tu.png","id":"tu"},
                {"url":"/static/public/libs/perfree-comment/imgs/wabi.png","id":"wabi"},
                {"url":"/static/public/libs/perfree-comment/imgs/weiqu.png","id":"weiqu"},
                {"url":"/static/public/libs/perfree-comment/imgs/weixiao.png","id":"weixiao"},
                {"url":"/static/public/libs/perfree-comment/imgs/woshou.png","id":"woshou"},
                {"url":"/static/public/libs/perfree-comment/imgs/wu.png","id":"wu"},
                {"url":"/static/public/libs/perfree-comment/imgs/xiaocry.png","id":"xiaocry"},
                {"url":"/static/public/libs/perfree-comment/imgs/xiaoerbuyu.png","id":"xiaoerbuyu"},
                {"url":"/static/public/libs/perfree-comment/imgs/xixi.png","id":"xixi"},
                {"url":"/static/public/libs/perfree-comment/imgs/xu.png","id":"xu"},
                {"url":"/static/public/libs/perfree-comment/imgs/ye.png","id":"ye"},
                {"url":"/static/public/libs/perfree-comment/imgs/yinxian.png","id":"yinxian"},
                {"url":"/static/public/libs/perfree-comment/imgs/yiwen.png","id":"yiwen"},
                {"url":"/static/public/libs/perfree-comment/imgs/youhengheng.png","id":"youhengheng"},
                {"url":"/static/public/libs/perfree-comment/imgs/yueliang.png","id":"yueliang"},
                {"url":"/static/public/libs/perfree-comment/imgs/yun.png","id":"yun"},
                {"url":"/static/public/libs/perfree-comment/imgs/yunbei.png","id":"yunbei"},
                {"url":"/static/public/libs/perfree-comment/imgs/zhuakuang.png","id":"zhuakuang"},
                {"url":"/static/public/libs/perfree-comment/imgs/zuohengheng.png","id":"zuohengheng"},
                {"url":"/static/public/libs/perfree-comment/imgs/zuoyi.png","id":"zuoyi"}
            ]
        },
        /**
         * 初始化
