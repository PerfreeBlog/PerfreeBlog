...
import { _ as ne, p as ie, d as E, A as re, a as se, b as ue, c as de, e as ce, f as me, g as pe, h as fe } from "./lib/attachLibraryItems.js";
const d = window.Vue.resolveComponent, t = window.Vue.createVNode, l = window.Vue.withCtx, n = window.Vue.unref, c = window.Vue.createTextVNode, v = window.Vue.createElementVNode, U = window.Vue.toDisplayString, ve = window.Vue.resolveDirective, x = window.Vue.openBlock, we = window.Vue.createBlock, _e = window.Vue.withDirectives, C = window.Vue.isRef, D = window.Vue.createElementBlock, he = window.Vue.createCommentVNode, ge = { class: "search-box" }, be = { class: "right-tool" }, ye = { class: "table-box" }, Ve = {
  class: "attach-audio",
  controls: "",
  preload: "none"
  ...
  __name: "AttachLibraryItemsAudio",
  ...
  setup(R) {
    const g = R, r = m({
      ...
      name: [{ required: !0, message: "音乐库名称不能为空", trigger: "blur" }],
      url: [{ required: !0, message: "音乐地址不能为空", trigger: "blur" }]
    }), N = m(), k = m();
    ...
    function j() {
      k.value.validate((o) => {
        o && (i.value.id ? de(i.value).then((e) => {
    ...
    function W(o) {
      V(), b.value = "修改音乐", s.value = !0, pe(o.id).then((e) => {
        i.value = e.data;
      });
    }
    function f() {
    ...
    function J() {
      V(), b.value = "添加音乐", s.value = !0;
    }
    return f(), (o, e) => {
      const A = d("el-input"), _ = d("el-form-item"), u = d("el-button"), z = d("el-form"), K = d("el-col"), O = d("el-row"), h = d("el-table-column"), Q = d("el-table"), X = d("el-pagination"), F = d("el-dialog"), Y = ve("loading");
      return x(), D("div", null, [
        v("div", ge, [
          t(z, {
            inline: !0,
...
}, Fe = /* @__PURE__ */ ne(Ne, [["__scopeId", "data-v-e521b90e"]]);
export {
  Fe as default
};
